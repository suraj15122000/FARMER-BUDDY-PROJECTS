...
$disp = mysqli_query($con, "SELECT fname FROM tbl_registration WHERE email='$mail'");

if ($row = mysqli_fetch_assoc($disp)) {
    $firstname = $row['fname'];
    echo "Hi " . $firstname . ", Something went wrong please try again later";
} else {
