...
<script>
    function checkLName() {
        ...
        if (document.getElementById('lastname').value == null || document.getElementById('lastname').value.trim().length === 0) {
            ...
            document.getElementById('lastname').value = "";
						...
						<span>Mobile number<label style="color:red;">*</label></span>
						 <input type="tel" name="phonem" id="phonem" placeholder="Phone number"  onblur="checkMob()"class="input input1 form-control"required>
			...
			<p id="erroremail"class="errmessage">    </p>
					...
					<p>Image</p>
					<input type="file" style="width:100%" name="images" class="btn thumbnail" id="images" accept="application/jpg" >
...
function fileSizeValidate1(fdata) {
	 if (fdata.files && fdata.files[0]) {
                var fsize = fdata.files[0].size/3072;
                if(fsize > maxSize) {
                	 //alert('Maximum file size exceed, This file size is: ' + fsize + "KB");
					 document.getElementById("ermsg1").innerHTML='Maximum file size(3 MB) exceed, This file size is: '+ fsize + "KB" ;
					 document.getElementById("image").value="";
                	 return false;
                } else {
					 document.getElementById("ermsg1").innerHTML="";
