...
<tr><th>Posted by</th><td><?php echo $prod[1] ?></td></tr>
<tr><th>Complaint Message</th><td><?php echo $prod['complaint_message'] ?><br></br>
<tr><th>Reply Message</th><td><?php echo $prod['replay_message'] ?><br></br>
