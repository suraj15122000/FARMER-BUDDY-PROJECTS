...
<body> 
  ...
  <p><?php echo $_SESSION['alogin']; ?></p>
			   ...
			   <form onsubmit="return validateForm()" action="seller_update_profile1.php" method="POST" id="update" name="update" > 
			   <h2 style "text-color:red";> Update details</h2>
			   <input type="text" name="firstname" id="firstname" class="input input1 form-control" placeholder="First Name" value="<?php echo @$fname;?>" onblur="checkFName()"  required>
			 ...
			 <input type="text" name="lastname" id="lastname" class="input input1 form-control"  placeholder="Last Name" value="<?php echo @$lname;?>" onblur="checkLName()"required>
			...
			<input type="text" name="phonem" id="phonem" placeholder="Phone number"class="input input1 form-control"   value="<?php echo @$mobile_num;?>" onblur="checkMob()"required>
