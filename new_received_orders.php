...
<tr><td colspan="2" ><center><a href="seller_update.order.php?orderid=<?php echo $prod['customer_order_id'] ?>" name="update_order" id="update_order" class="btn btn-danger btn-sm " style="background-color:green;color:lack ;font-weight:bold" > Update Order status</Button></center></td>
